...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_cube()
    test_volume_amount = volume_of_cube(3)
    assert_equal(27, test_volume_amount)
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    test_volume_sphere = volume_of_sphere(1)
    assert_equal((4/3) * Math::PI, test_volume_sphere)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    test_celsius = farenheit_to_celsius(32)
    assert_equal(0, test_celsius)
  end
